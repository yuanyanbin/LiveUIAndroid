...
import com.baijiayun.live.httputils.util.MD5;
import com.baijiayun.live.httputils.util.NetConnectUtil;
...
import static com.baijiayun.live.httputils.constant.Constants.TYPE_GET;
import static com.baijiayun.live.httputils.constant.Constants.TYPE_POST_FORM;
import static com.baijiayun.live.httputils.constant.Constants.TYPE_POST_JSON;
...
//                        failedCallBack("服务器连接超时，过会儿再试试", callBack);
    ...
    boolean isT = false;    //token err之前是否登录成功过
        ...
        try {
            ...
            for (String key : paramsMap.keySet()) {
                ...
                if (!(object instanceof File)) {
                    ...
                    builder.addFormDataPart(key, file.getName(), createCustomRequestBody(MultipartBody.FORM, file, callBack));
